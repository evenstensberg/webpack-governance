...
The webpack's *[insert WG name]* is governed by a Working Group (WG)
...
Use of a CLA or DCO is mandatory for all all OpenJS Foundation projects. The webpack project has chosen to use the DCO 1.1
...
<!-- WGs will be created after the new Governance model is created -->

----

This work is a derivative of the [Node.js Project Working Group Model](https://github.com/nodejs/TSC/blob/main/WORKING_GROUPS.md).

[consensus seeking]: https://en.wikipedia.org/wiki/Consensus-seeking_decision-making
[technical steering committee]: ./GOVERNANCE.md#technical-steering-committee-tsc